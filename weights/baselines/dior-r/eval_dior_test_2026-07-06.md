...
- 权重路径：`weights/baselines/dior-r/yolo11n-obb-dior-r-best.pt`
- 实验变体：`baseline`
- 参数量：2,657,623
- GFLOPs：6.6
- 数据集配置：`DIOR.yaml`
...
|---:|---:|---:|---:|---:|---:|
| 0.852 | 0.815 | 0.8588 | 0.6874 | 2332 | 19651 |

小目标结果，面积 `< 1024`：

| P | R | mAP50 | mAP50-95 | 图像数 | 实例数 |
|---:|---:|---:|---:|---:|---:|
| 0.660 | 0.517 | 0.5146 | 0.3470 | 2332 | 12918 |

备注：

- DIOR-R test 中有 15 个标签因坐标未归一化或越界被评估过程忽略。
- 本次评估对应的 Ultralytics 原始结果目录：`runs/obb/val3` 和 `runs/obb/val4`。
